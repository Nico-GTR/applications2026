...
ROLE_THEMES = [
    ...
    ("Generative AI / LLM", ["generative", "generatif", "llm", "genai", "ia gen", "agents", "world model", "foundation", "fondation"]),
    ("Computer Vision", ["vision", "image", "traitement d'image", "imagerie"]),
    ("AI (general)", ["intelligence artificielle", " ia ", "ia ", " ia", "ai ", " ai", "ia/", "/ia"]),
    ("Robotics", ["robot", "robotique"]),
    ("Software Dev", ["developpeur", "logiciel", "software", "developpement", "developer", "informatique"]),
...
FR_WEEKDAYS = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]
FR_MONTHS = ["", "Jan", "Feb", "Mar", "Apr", "May", "Jun",
...
def main():
    ...
    buckets = Counter()
    bucket_order = ["≤ 3d", "4–7d", "8–14d", "15–30d", "> 30d"]
    for d in resp:
        if d <= 3:
            buckets["≤ 3d"] += 1
        elif d <= 7:
    ...
    with open(OUT_JS, "w", encoding="utf-8") as f:
        f.write("// Auto-generated by prepare_data.py — do not edit by hand.\n")
